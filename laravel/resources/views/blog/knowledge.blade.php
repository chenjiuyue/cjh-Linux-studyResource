...
<article class="blogs">
    ...
    <div class="newblog left">
        ...
        <figure><img src="{{URL::asset('blog/images/01.jpg')}}"></figure>
        <ul class="nlist">
        ...
        <p class="dateview"><span>发布时间：2013-11-04</span><span>作者：杨青</span><span>分类：[<a href="/news/life/">个人博客模板</a>]</span></p>
        <figure><img src="{{URL::asset('blog/images/02.jpg')}}"></figure>
        <ul class="nlist">
        ...
        <p class="dateview"><span>发布时间：2013-11-04</span><span>作者：杨青</span><span>分类：[<a href="/news/life/">个人博客模板</a>]</span></p>
        <figure><img src="{{URL::asset('blog/images/03.jpg')}}"></figure>
        <ul class="nlist">
        ...
        <h2>女生清新个人博客网站模板</h2>
        <p class="dateview"><span>发布时间：2013-11-04</span><span>作者：杨青</span><span>分类：[<a href="/news/life/">个人博客模板</a>]</span></p>
        <figure><img src="{{URL::asset('blog/images/04.jpg')}}"></figure>
        <ul class="nlist">
        ...
        <div class="blank"></div>
        <div class="ad">
            <img src="{{URL::asset('blog/images/ad.png')}}">
        </div>
